...
class ReportGenerator {
  static Future<File> generateProjectReport() async {
    ...
    final output = await getApplicationDocumentsDirectory();
    final reportsDir = Directory('${output.path.replaceAll('\\AppData\\Local\\mzansi_meds_reminder\\', '')}/Desktop/ProgrammingProject/med_adhere');
    ...
    try {
      ...
      // Fallback to app documents directory if path creation fails
    }
    
    final file = File('${reportsDir.path}/MedAdhere_Project_Report_May2026.pdf');
